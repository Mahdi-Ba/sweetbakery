...
class Product(models.Model):
    ...
    name = models.CharField(max_length=255)
    unit_title = models.CharField(max_length=255,null=True,blank=True)
    ...
    extra_discount_price = models.IntegerField(null=True,blank=True)
